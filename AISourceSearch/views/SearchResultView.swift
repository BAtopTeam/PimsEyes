...
struct SearchResultView: View {
    ...
    private let hasShownRateKey = "hasShowRateAs"
    ...
    var body: some View {
        ...
        .onAppear {
            let hasShownRate = UserDefaults.standard.bool(forKey: hasShownRateKey)
            if !hasShownRate {
                showRateUs = true
                UserDefaults.standard.set(true, forKey: hasShownRateKey)
            }
        }
        .background(Color(hex: "F4F6F8"))
    }
