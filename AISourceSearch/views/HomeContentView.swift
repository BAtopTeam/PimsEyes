...
struct HomeContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            VStack(spacing: 8) {
                HomeButton(image: .photo, title: "Upload an image", action: {
                    activeActionSheet = .image
                })
                HomeButton(image: .file, title: "Choose a file", action: {
    ...
    private func requestPhotoAccess(completion: @escaping () -> Void) {
